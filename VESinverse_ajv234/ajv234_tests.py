...
# Layer 3 Tests
    ...
    def test_3L_R1_D1(self):            # test_number == 4
        ...
        self.assertEqual(round(VI.pkeep[3], 3), 5.977)
        print("Layer 2 tests Completed")
        self.assertEqual(round(VI.pkeep[4], 3), 850.819)
        print("Layer 3 tests Completed")
        self.assertEqual(round(VI.errmin, 5), 0.07708)
        print("RMS test Completed")

        self.assertEqual(VI.adat[0], 0.55)
        self.assertEqual(VI.adat[1], 0.95)
        self.assertEqual(VI.adat[2], 1.5)
        self.assertEqual(VI.adat[3], 2.5)
        self.assertEqual(VI.adat[4], 3)
        self.assertEqual(VI.adat[5], 4.5)
        self.assertEqual(VI.adat[6], 5.5)
        self.assertEqual(VI.adat[7], 9)
        self.assertEqual(VI.adat[8], 12)
        self.assertEqual(VI.adat[9], 20)
        self.assertEqual(VI.adat[10], 30)
        self.assertEqual(VI.adat[11], 70)
        print("\"Spacing\" tests Completed")

        self.assertEqual(VI.rdat[0], 125)
        self.assertEqual(VI.rdat[1], 110)
        self.assertEqual(VI.rdat[2], 95)
        self.assertEqual(VI.rdat[3], 40)
        self.assertEqual(VI.rdat[4], 24)
        self.assertEqual(VI.rdat[5], 15)
        self.assertEqual(VI.rdat[6], 10.5)
        self.assertEqual(VI.rdat[7], 8)
        self.assertEqual(VI.rdat[8], 6)
        self.assertEqual(VI.rdat[9], 6.5)
        self.assertEqual(VI.rdat[10], 11)
        self.assertEqual(VI.rdat[11], 25)
    ...
    def test_3L_R2_D3(self):            # test_number == 1
        ...
        self.assertEqual(round(VI.pkeep[2], 3), 123.969)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[1], 3), 31.392)
        self.assertEqual(round(VI.pkeep[3], 3), 7.610)
        print("Layer 2 tests Completed")
        self.assertEqual(round(VI.pkeep[4], 3), 358.811)
        print("Layer 3 tests Completed")
        ...
        self.assertEqual(VI.rdat[0], 125)
        self.assertEqual(VI.rdat[1], 124)
        self.assertEqual(VI.rdat[2], 120)
        self.assertEqual(VI.rdat[3], 115)
        self.assertEqual(VI.rdat[4], 110)
        self.assertEqual(VI.rdat[5], 95)
        self.assertEqual(VI.rdat[6], 40)
        self.assertEqual(VI.rdat[7], 24)
        self.assertEqual(VI.rdat[8], 15)
        self.assertEqual(VI.rdat[9], 10)
        self.assertEqual(VI.rdat[10], 11)
        self.assertEqual(VI.rdat[11], 25)
        print("\"Origianl_Data\" tests Completed")
    ...
    def test_3L_R2_D1(self):            # test_number == 2
        ...
        self.assertEqual(round(VI.pkeep[2], 3), 103.591)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[1], 3), 38.001)
        self.assertEqual(round(VI.pkeep[3], 3), 11.226)
        print("Layer 2 tests Completed")
        self.assertEqual(round(VI.pkeep[4], 3), 93.574)
        print("Layer 3 tests Completed")
    ...
    def test_3L_R2_D2(self):            # test_number == 3
        ...
        self.assertEqual(round(VI.pkeep[2], 3), 128.599)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[1], 3), 4.109)
        self.assertEqual(round(VI.pkeep[3], 3), 350.702)
        print("Layer 2 tests Completed")
        self.assertEqual(round(VI.pkeep[4], 3), 57.086)
        print("Layer 3 tests Completed")
        ...
        self.assertEqual(VI.rdat[0], 125)
        self.assertEqual(VI.rdat[1], 130)
        self.assertEqual(VI.rdat[2], 140)
        self.assertEqual(VI.rdat[3], 150)
        self.assertEqual(VI.rdat[4], 160)
        self.assertEqual(VI.rdat[5], 170)
        self.assertEqual(VI.rdat[6], 175)
        self.assertEqual(VI.rdat[7], 170)
        self.assertEqual(VI.rdat[8], 130)
        self.assertEqual(VI.rdat[9], 100)
        self.assertEqual(VI.rdat[10], 80)
        self.assertEqual(VI.rdat[11], 60)
        print("\"Origianl_Data\" tests Completed")
    ...
    def test_3L_R1_D2(self):            # test_number == 5
        ...
        self.assertEqual(round(VI.pkeep[2], 3), 157.388)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[1], 3), 71.670)
        self.assertEqual(round(VI.pkeep[3], 3), 83.794)
        print("Layer 2 tests Completed")
        self.assertEqual(round(VI.pkeep[4], 2), 2230.04)
        print("Layer 3 tests Completed")
    ...
    def test_3L_R1_D3(self):            # test_number == 6
        ...
        self.assertEqual(round(VI.pkeep[2], 3), 144.197)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[1], 3), 44.508)
        self.assertEqual(round(VI.pkeep[3], 3), 9.867)
        print("Layer 2 tests Completed")
        self.assertEqual(round(VI.pkeep[4], 2), 1075.63)
        print("Layer 3 tests Completed")
...
# Layer 2 Tests
    def test_2L_R3_D4(self):            # test_number == 7
        ...
        self.assertEqual(round(VI.pkeep[1], 3), 123.045)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[2], 3), 202.736)
        print("Layer 2 tests Completed")
        ...
        self.assertEqual(VI.rdat[0], 125)
        self.assertEqual(VI.rdat[1], 124)
        self.assertEqual(VI.rdat[2], 126)
        self.assertEqual(VI.rdat[3], 129)
        self.assertEqual(VI.rdat[4], 135)
        self.assertEqual(VI.rdat[5], 140)
        self.assertEqual(VI.rdat[6], 150)
        self.assertEqual(VI.rdat[7], 170)
        self.assertEqual(VI.rdat[8], 175)
        self.assertEqual(VI.rdat[9], 180)
        self.assertEqual(VI.rdat[10], 185)
        self.assertEqual(VI.rdat[11], 187)
        print("\"Origianl_Data\" tests Completed")
    ...
    def test_2L_R3_D5(self):            # test_number == 8
        ...
        self.assertEqual(round(VI.pkeep[1], 3), 125.694)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[2], 3), 26.060)
        print("Layer 2 tests Completed")
        ...
        self.assertEqual(VI.rdat[1], 124)
        self.assertEqual(VI.rdat[2], 126)
        self.assertEqual(VI.rdat[3], 122)
        self.assertEqual(VI.rdat[4], 120)
        self.assertEqual(VI.rdat[5], 110)
        self.assertEqual(VI.rdat[6], 85)
        self.assertEqual(VI.rdat[7], 65)
        self.assertEqual(VI.rdat[8], 40)
        self.assertEqual(VI.rdat[9], 30)
        self.assertEqual(VI.rdat[10], 26)
        self.assertEqual(VI.rdat[11], 25)
        print("\"Origianl_Data\" tests Completed")
    ...
    def test_2L_R4_D5(self):            # test_number == 9
        ...
        self.assertEqual(round(VI.pkeep[1], 3), 130.232)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[2], 3), 25.557)
        print("Layer 2 tests Completed")
    ...
    def test_2L_R3_D6(self):            # test_number == 10
        ...
        self.assertEqual(round(VI.pkeep[1], 3), 119.676)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[2], 3), 367.937)
        print("Layer 2 tests Completed")
        ...
        self.assertEqual(VI.rdat[3], 129)
        self.assertEqual(VI.rdat[4], 135)
        self.assertEqual(VI.rdat[5], 180)
        self.assertEqual(VI.rdat[6], 220)
        self.assertEqual(VI.rdat[7], 250)
        self.assertEqual(VI.rdat[8], 280)
        self.assertEqual(VI.rdat[9], 300)
        self.assertEqual(VI.rdat[10], 310)
        self.assertEqual(VI.rdat[11], 315)
        print("\"Origianl_Data\" tests Completed")
    ...
    def test_2L_R4_D6(self):            # test_number == 11
        ...
        self.assertEqual(round(VI.pkeep[1], 3), 176.162)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[2], 3), 49.803)
        print("Layer 2 tests Completed")
...
# Layer 4 Tests
    ...
    def test_4L_R5_D7(self):            # test_number == 12
        ...
        self.assertEqual(round(VI.pkeep[3], 3), 296.297)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[1], 3), 2.375)
        self.assertEqual(round(VI.pkeep[4], 3), 460.889)
        print("Layer 2 tests Completed")
        self.assertEqual(round(VI.pkeep[2], 3), 40.382)
        self.assertEqual(round(VI.pkeep[5], 3), 167.079)
        print("Layer 3 tests Completed")
        self.assertEqual(round(VI.pkeep[6], 3), 298.098)
        ...
        self.assertEqual(VI.rdat[0], 300)
        self.assertEqual(VI.rdat[1], 303)
        self.assertEqual(VI.rdat[2], 330)
        self.assertEqual(VI.rdat[3], 330)
        self.assertEqual(VI.rdat[4], 310)
        self.assertEqual(VI.rdat[5], 300)
        self.assertEqual(VI.rdat[6], 285)
        self.assertEqual(VI.rdat[7], 240)
        self.assertEqual(VI.rdat[8], 205)
        self.assertEqual(VI.rdat[9], 180)
        self.assertEqual(VI.rdat[10], 180)
        self.assertEqual(VI.rdat[11], 210)
        print("\"Origianl_Data\" tests Completed")
    ...
    def test_4L_R6_D7(self):            # test_number == 13
        ...
        self.assertEqual(round(VI.pkeep[3], 3), 297.627)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[1], 3), 1.882)
        self.assertEqual(round(VI.pkeep[4], 3), 487.500)
        print("Layer 2 tests Completed")
        self.assertEqual(round(VI.pkeep[2], 3), 45.598)
        self.assertEqual(round(VI.pkeep[5], 3), 173.399)
        print("Layer 3 tests Completed")
        self.assertEqual(round(VI.pkeep[6], 3), 399.572)
        print("Layer 4 tests Completed")
    ...
    def test_4L_R7_D7(self):            # test_number == 14
        ...
        self.assertEqual(round(VI.pkeep[3], 3), 326.917)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[1], 3), 41.975)
        self.assertEqual(round(VI.pkeep[4], 3), 159.527)
        print("Layer 2 tests Completed")
        self.assertEqual(round(VI.pkeep[2], 3), 38.790)
        self.assertEqual(round(VI.pkeep[5], 3), 310.892)
        print("Layer 3 tests Completed")
        self.assertEqual(round(VI.pkeep[6], 3), 346.099)
        print("Layer 4 tests Completed")
    ...
    def test_4L_R7_D8(self):            # test_number == 15
        ...
        self.assertEqual(round(VI.pkeep[3], 3), 279.980)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[1], 3), 2.219)
        self.assertEqual(round(VI.pkeep[4], 3), 441.355)
        print("Layer 2 tests Completed")
        self.assertEqual(round(VI.pkeep[2], 3), 16.897)
        self.assertEqual(round(VI.pkeep[5], 3), 494.218)
        print("Layer 3 tests Completed")
        self.assertEqual(round(VI.pkeep[6], 3), 326.87)
        print("Layer 4 tests Completed")
        ...
        self.assertEqual(VI.rdat[0], 300)
        self.assertEqual(VI.rdat[1], 298)
        self.assertEqual(VI.rdat[2], 290)
        self.assertEqual(VI.rdat[3], 270)
        self.assertEqual(VI.rdat[4], 280)
        self.assertEqual(VI.rdat[5], 300)
        self.assertEqual(VI.rdat[6], 330)
        self.assertEqual(VI.rdat[7], 370)
        self.assertEqual(VI.rdat[8], 420)
        self.assertEqual(VI.rdat[9], 510)
        self.assertEqual(VI.rdat[10], 507)
        self.assertEqual(VI.rdat[11], 370)
        print("\"Origianl_Data\" tests Completed")
    ...
    def test_4L_R6_D8(self):            # test_number == 16
        ...
        self.assertEqual(round(VI.pkeep[3], 3), 281.464)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[1], 3), 1.099)
        self.assertEqual(round(VI.pkeep[4], 3), 173.206)
        print("Layer 2 tests Completed")
        self.assertEqual(round(VI.pkeep[2], 3), 46.318)
        self.assertEqual(round(VI.pkeep[5], 3), 497.618)
        print("Layer 3 tests Completed")
        self.assertEqual(round(VI.pkeep[6], 3), 255.004)
        print("Layer 4 tests Completed")
    ...
    def test_4L_R5_D8(self):            # test_number == 17
        ...
        self.assertEqual(round(VI.pkeep[3], 3), 268.001)
        print("Layer 1 tests Completed")
        self.assertEqual(round(VI.pkeep[1], 3), 11.240)
        self.assertEqual(round(VI.pkeep[4], 3), 404.555)
        print("Layer 2 tests Completed")
        self.assertEqual(round(VI.pkeep[2], 3), 46.858)
        self.assertEqual(round(VI.pkeep[5], 3), 454.764)
        print("Layer 3 tests Completed")
        self.assertEqual(round(VI.pkeep[6], 3), 293.497)
        print("Layer 4 tests Completed")
